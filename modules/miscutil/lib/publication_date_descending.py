...
def publication_date_descending(output_file):
#test_year = re.compile('^[1-20-90-90-9]+$')
#test_year = re.compile('^(15|16|17|18|19|20)\d\d$')
...
# If year format is wrong, then value is 0.
    ...
    year_sorted_by_recid_tuples = sorted(year_cleaned_tuples, key=lambda tuple: tuple[0])
    ...
    for year_row in year_sorted_by_recid_tuples:
        ...
        for title_row in title_sorted_by_recid_tuples:
            ...
            if recid_title == recid_year:
                ...
                title_year_ranked.append(year_row[1] + title_row[2])
